              ...
              <div className="fixed inset-0 z-50 flex items-center justify-center p-4"
                ...
                <div className="w-full max-w-md bg-gray-900 border border-white/[0.07] rounded-2xl shadow-2xl p-6">
                  ...
                  <MultiGatewayCheckout
                    recipient={{
                      displayName: recipientName || recipientUpiId,
                ...
                >
                  <div className="p-6 space-y-4">
                    ...
                    <p className="text-sm text-white/70">
                      ...
                      A 2-minute security hold applies to first-time payments to protect you from social engineering fraud.
                    </p>
