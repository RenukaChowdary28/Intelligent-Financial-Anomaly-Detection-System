...
// ── Root error boundary — prevents any single page crash from blanking the app
...
import GhostHunter from './components/logic/GhostHunter'
import BankLinking from './components/logic/BankLinking'
import CashFlowForecast from './components/logic/CashFlowForecast'
import FinancialPersonality from './components/logic/FinancialPersonality'
...
const RouteTitleUpdater = () => {
  ...
  useEffect(() => {
    const routeToTitle = {
      ...
      '/bank-linking':         'AegisAI - Link Bank Account',
      '/ghost-hunter':        'AegisAI - Ghost Hunter',
      '/cashflow-forecast':   'AegisAI - Cash Flow Forecast',
      '/financial-personality':'AegisAI - Financial Personality',
    };
  ...
  return (
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path="/bank-linking"          element={<PrivateRoute element={<BankLinking />} />} />
        <Route path="/ghost-hunter"          element={<PrivateRoute element={<GhostHunter />} />} />
        <Route path="/cashflow-forecast"     element={<PrivateRoute element={<CashFlowForecast />} />} />
        <Route path="/financial-personality" element={<PrivateRoute element={<FinancialPersonality />} />} />
      </Routes>
    </Router>
    </AppErrorBoundary>
  );
